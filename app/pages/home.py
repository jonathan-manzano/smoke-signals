...
layout = html.Div([
    ...
    html.Section(
      html.Div([
        ...
        html.P(
          ...
          "This project explores PM2.5 data to understand the effects on air quality.",
          className="lead"
        ),
      ], className="container"),
      className="hero hero--blue"
    ),
    ...
    html.Section(
      html.Div([
      html.Div([
        html.H3("Sample Blue Card"),
        html.P(
        "This is a sample blue card with placeholder text. "
        "You can replace this text with any relevant information."
        ),
